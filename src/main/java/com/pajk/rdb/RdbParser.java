	...
	private void rdbParseBody(RandomAccessFile position, CallBackHandler handler) {
		...
		while (true) {
			...
			case REDIS_LIST:
				...
				listValues = (List<String>) value;
				keySize = listValues.size();
				break;
			case REDIS_SET:
				Set<String> setValues = new HashSet<String>();
				setValues = (Set<String>) value;
				keySize = setValues.size();
				break;
			case REDIS_ZSET:
				TreeMap<Double, String> zsetValues = new TreeMap<Double, String>();
				zsetValues = (TreeMap<Double, String>) value ;
				keySize = zsetValues.size();
				break;
			case REDIS_HASH:
				HashMap<String, String> mapValues = new HashMap<String, String>();
				mapValues = (HashMap<String, String>) value;
				keySize = mapValues.size();
				break;
			default: break;
			};
			handler.printlnHandler(dbid, valType, key, value, expiretime,keySize);
		}
	}
